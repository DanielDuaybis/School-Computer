...
#Waldo
waldo = Image(Point(600,550),"Waldo.ppn")
waldo.draw(window)
x = 1
while(x > 0):
    window.getMouse()
...
shirt = Rectangle(Point(45,500),Point(65,550))
shirt.setFill('red')
shirt.draw(window)
...
mouthcover = Rectangle(Point(45,475),Point(65,485))
...
rightpupil = Circle(Point(48,475),2)
rightpupil.setFill('blue')
rightpupil.setOutline('blue')
rightpupil.draw(window)

lefteye = Circle(Point(65,475),5)
lefteye.setFill('white')
lefteye.draw(window)

leftpupil = Circle(Point(65,475),2)
